...
10 42.4943, 3916.25
11 42.1849, 5646.74
test when d = 15, 5646.74
```

```txt
als.cpp 使用按照用户划分的数据集 随机初始化（随机种子为1）
Train Set
148108 1848063
19353712
Test Set
...
10 42.6603, 1524.28
11 42.4111, 1650.27
test when d = 15, 1650.27
```

```txt
als.cpp 随机划分的数据集 随机初始化（随机种子为1）
Train Set
148108 1848063
19296282
Test Set
